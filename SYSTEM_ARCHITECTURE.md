...
## 1. STRATEGIC MISSION
The Order is an "Intelligence vs. Execution" engine designed to bypass algorithmic spam filters by separating high-level strategic "Recipes" from "Biological Execution."
...
8.  **Phase 8: Persona Modulation** — **(Latest Addition)** Dynamically refines tone (e.g., Venora) without altering structure.
9.  **Phase 9: Physics Audit** — Final check for "Text Clog" and engagement gaps.
10. **Phase 10: Final Assembly** — Assembles the finalized "Field Manual" in Markdown.
...
| **Value Agent** | Insights Specialist | Strategy-to-Talking-Point Translation |
| **Physics Agent** | Conversion Coach | Guardrail Enforcement & Audit |
| **Marketing Agent** | Lead Scripter | Synthesis & Skeleton Generation |
